...
from jukebox.misc.inputminus import msg_highlight
from jukebox.misc.simplecolors import Colors
import jukebox.cfghandler

# TODO: jukebox.hostif was removed along with the old plugin system (see
# documentation/developers/roadmap-core-architecture.md) and hasn't been reintroduced yet.
import jukebox.hostif.linux as host  # noqa: E402
